      ...
      <div>
        ...
        <div className="history-body">
          <p className="btc-history">
            ...
            invented by the mysterious Satoshi Nakamoto in 2008 and is the first
            decentralized cryptocurrency. The first bitcoin transaction took
            place between Nakamoto and an early adopter of bitcoin in January
            2009. Since the release of bitcoin, many other cryptocurrencies have
            been created. You can read more about cryptocurrency via Wikipedia,
            source:{" "}
            <a
          ...
          <p>
            ...
            mechanisms. Cryptocurrency does not exist in physical form (like
            ...
            central bank digital currency (CBDC). When a cryptocurrency is
            minted or created prior to issuance or issued by a single issuer, it
            is generally considered centralized. When implemented with
          ...
          <p className="pizza">
            ...
            million. Making it the most expensive pizza purchase in history. At
            the time of purchase, Hanyecz's 10,000 BTC was worth a mere $40. You
            can read more about the worlds most expensive pizzas via Yahoo,
            source:{" "}
            <a
